...
export type BaseSelectProps = React.ComponentProps<typeof SelectPrimitive.Root>;
...
function SelectScrollUpButton({ className, ...props }: SelectPrimitive.ScrollUpArrow.Props) {
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      className={cn(
        'bg-popover z-51 text-md flex h-6 w-full cursor-default items-center justify-center border text-center data-[direction=down]:rounded-b-md data-[direction=up]:rounded-t-md data-[direction=down]:border-t-0 data-[direction=up]:border-b-0',
